...
public static List<LangModel> getSoundnsme(){
    ...
    sounds.add(new LangModel("You_Are_Mumu_Man", R.drawable.a, R.raw.a12, "60", "0"));
    sounds.add(new LangModel("Investigations", R.drawable.a, R.raw.a11, "61", "0"));
    sounds.add(new LangModel("I_no_Dey_Hear_Word", R.drawable.a, R.raw.a108, "62", "0"));
    sounds.add(new LangModel("Broda_Shaggi", R.drawable.a, R.raw.a107, "63", "0"));
    sounds.add(new LangModel("Nollywood_Laugh", R.drawable.a, R.raw.a106, "64", "0"));
    sounds.add(new LangModel("What_Is_Going_On", R.drawable.a, R.raw.a105, "65", "0"));
    sounds.add(new LangModel("Is_It_For_Eba", R.drawable.a, R.raw.a104, "66", "0"));
    sounds.add(new LangModel("Help_Me", R.drawable.a, R.raw.a103, "67", "0"));
    sounds.add(new LangModel("What_Type_Of_Playing_Is_This", R.drawable.a, R.raw.a102, "68", "0"));
    sounds.add(new LangModel("I_Want_Problem", R.drawable.a, R.raw.a101, "69", "0"));
    sounds.add(new LangModel("Murife_Dont_Run", R.drawable.a, R.raw.a10, "70", "0"));
    sounds.add(new LangModel("Just_Dey_Play", R.drawable.a, R.raw.a1, "71", "0"));
    sounds.add(new LangModel("Wetin_Be_This", R.drawable.a, R.raw.a0, "72", "0"));
    return sounds;
}
