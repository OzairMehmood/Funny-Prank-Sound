package com.ozair.funnysounds.nativetemplates;

public class ConstantAds {

    public static String position = "posit";
    public static String result = "path";
    public static String KeyOne = "data";
    public static String KeyTwo = "position";
    public static String imgShare = "imgshr";
    public static String eng1 = "eng1";
    public static String urdu1 = "urdu1";
