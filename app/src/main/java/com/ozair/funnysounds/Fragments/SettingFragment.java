...
import com.ozair.funnysounds.Activities.LanguageActivity;
import com.ozair.funnysounds.Activities.PrivacyPoliecy;
...
//        });
        ...
        privacybtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(), PrivacyPoliecy.class));
            }
        });
    }
